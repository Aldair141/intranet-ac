...
{
    public class TipoDocumentoRepositorio: Repositorio<TipoDocumento>, ITipoDocumentoRepository
    {
        private readonly ApplicationDbContext _db;

        public TipoDocumentoRepositorio(ApplicationDbContext db) : base(db)
        {
            _db = db;
        }
    }
